...
\begin{document}
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de Dead-Code Insertion}, language={[x86masm]Assembler}]
			; Before obfuscation
			xor eax, eax
			move eax, 0x2D
			mov ecx, 0xA
	...
	También conocido como Block Reordering, es una técnica que reordena el flujo del proceso cambiando bloques del código que tienen subrutinas independientes. Si un código tiene n subrutinas de código, tendrá \verb*|n!| permutaciones para reordenar dicho código.
	
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de sustitución de subroutine reordering}, language={[x86masm]Assembler}]
			; Before obfuscation
			mov eax , ebx
			add ecx , edx
			add eax , ecx
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de IIFFE 1}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de IIFFE 2}, language={Java}]
			function hello(message) {
				console.log(message)
			}
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de IIFFE 3}, language={Java}]
			(function hello(message) {
				console.log(message)
			})('This is test')
		\end{lstlisting}
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de IIFFE 4}, language={Java}]
			(function(quhuvu6) {
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 2}, language={Java}]
			function cicuza(syhri) {
				var result = [];
				for (var segovmiw4 = parseInt((0).toString(36)) /*CN1b367Z19XZqi8XgI67*/ ; segovmiw4 < syhri["l" + ("F", "T", "H", "e") + "n" + ("G", "n", "O", "g") + (29).toString(36) + ("u", "X", "U", "p", "h")]; segovmiw4 += parseInt((2).toString(36))) {
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 3}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 4},language={Java}]
			function cicuza(syhri) {
				var result = [];
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 5}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 6}, language={Java}]
			function cicuza(val) {
				var result = [];
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 7}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 8}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 9}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores 10}, language={Java}]
			val["substr"](i, 2)
		\end{lstlisting}
	\end{scriptsize}
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de operadores post}, language={Java}]
			(...)
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 1}, language={Java}]
			function doubleX(x) {
				return x * 2
			}
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 2}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 3}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 4}, language={Java}]
			let sdfgfdg = "".substr
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 5}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 6}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 7}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 8}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de obtener el constructor 9},  language={Java}]
			(function(quhuvu6) {
	...
	\begin{scriptsize}
	\estiloR
	\begin{lstlisting}[caption={Ejemplo de Operadores Lógicos 1},  language={Java}]
   while (mirjokbynet <= permy[("h", "g", "B", "W", "l") + "e" + (23).toString(0x24) + "g" + ("u", "Z", "W", "u", "t") + (17).toString(36)]) {
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de Operadores Lógicos 2}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de Operadores Lógicos 3}, language={Java}]
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de Operadores Lógicos 4}, language={Java}]
			dikol = (permy.substr(permy.length - k)).split('');
		\end{lstlisting}
	\end{scriptsize}
	...
	\begin{scriptsize}
		\estiloR
		\begin{lstlisting}[caption={Ejemplo de Operadores Lógicos 5}, language={Java}]
			for (var j = +!!false; j < defiq.length; j++) {
				defiq[j] = defiq[j] ^ dikol[j % dikol.length].charCodeAt(0);
			}
		\end{lstlisting}
	...
	\subsubsection{Código en un conjunto de enteros}
	Nos podemos encontrar como en esta muestra, sacada de un pdf, la función \verb*|var n = ""; eval(eval('Stri'+ n + 'ng.fr' + n + 'omCharC' + n + 'ode| con un listado de números. Si nos vamos a CyberChef, reemplazamos las comas por espacios y ejecutamos \textit{From Charcode} con la base en 10, vemos que se transforma en un código en Javascript:
	\begin{figure}[H]
		\centering
		\includegraphics[width=15cm]{images/pdf1.png}
		\caption{Conjunto de enteros}
	\end{figure}
	\begin{figure}[H]
		\centering
	...
	Se ha desarrollado una herramienta, basándonos en los análisis que hemos mencionado anteriormente para facilitar la desofuscación de malware en JavaScript y su análisis.
	
	Esta herramienta tendrá las siguientes funcionalisades:
	\begin{itemize}
		...
		\item Checkeo de entropía, línea por línea o por texto completo.
