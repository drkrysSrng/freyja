   ...
   return res
	...
	\begin{scriptsize}
		...
		\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 1: Beautify}, language={bash}]
			freyja -f ./samples/Sample1/ejercicio6.js -l 1
		\end{lstlisting}
	\end{scriptsize}
	...
	\end{figure}
		...
		\begin{scriptsize}
			...
			\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 2: Hexadecimal}, language={bash}]
				freyja -f ./samples/b122473d00566758d09c695d191b368e0c815c65e8acc0f00da7a88e45cc8a9e.js -l 2
			\end{lstlisting}
		\end{scriptsize}
...
return data
	...
	\begin{scriptsize}
		...
		\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 3: Unicode}, language={bash}]
			freyja -f ./samples/b122473d00566758d09c695d191b368e0c815c65e8acc0f00da7a88e45cc8a9e.js -l 3
		\end{lstlisting}
	\end{scriptsize}
...
def replace_hex_tostring(data):
	...
	\begin{scriptsize}
		...
		\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 4 y 5: toString}, language={bash}]
			freyja -f ./samples/simple_js_malware_code/do_not_run.js -l 4
		\end{lstlisting}
	\end{scriptsize}
	...
	\begin{scriptsize}
		...
		\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 6: Eval}, language={bash}]
			freyja -f ./samples/sample_2_extracted/sample_2.js -l 6
		\end{lstlisting}
	\end{scriptsize}
	...
	\begin{scriptsize}
		...
		\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 7: unescape}, language={bash}]
			freyja -f ./samples/javascript-malware-collection/2016/20160311/20160311_01284d18e603522cc8bdabed57583bb3.js -l 7
		\end{lstlisting}
	\end{scriptsize}
	...
	\begin{scriptsize}
		...
		\begin{lstlisting}[caption={Desofuscación de ficheros JavaScript Nivel 8: Conjuntos de caracteres}, language={bash}]
			freyja -f freyja -f ./samples/simple_js_malware_code/do_not_run.js -l 8
		\end{lstlisting}
	\end{scriptsize}
